...
// Code Here
let doubled = myNumbers.map((el, i, arr) => {
	return el * 2
})
...
let filtered = myNumbers.filter((el, i, arr) => {
	return el > 100
})
...
// Code Here
let total = myNumbers.reduce((total, nextNum) => {
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map((el, i, arr) => {
	return el[i] = "George"
})
...
let totallyAwesome = people.reduce((total, nextNum, arr) => {
